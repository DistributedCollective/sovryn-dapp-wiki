...
| Name | Rule | Example |
| ---- | ---- | ---- |
| Global/File Constants | UPPERCASE | CONSTANTS_ARE_UNCHANGEABLE |
...
* You can read more about this problem in [this article](https://medium.com/open-graphql/apollo-multiple-clients-with-react-b34b571210a5`), however, we decided to pass a custom `client` to queries if needed (if it presents a significant overhead, there is no problem to use multiple `ApolloProvider` instances in the future).
...
* Components should follow our [Design Guidelines](Design)
...
* Text copy should follow Sovryn's [Text Style Guide](Text-Style-Guide).
